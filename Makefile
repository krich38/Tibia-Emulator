...
ACLOCAL = ${SHELL} /root/tfs1/missing --run aclocal-1.11
AMTAR = ${SHELL} /root/tfs1/missing --run tar
AUTOCONF = ${SHELL} /root/tfs1/missing --run autoconf
AUTOHEADER = ${SHELL} /root/tfs1/missing --run autoheader
AUTOMAKE = ${SHELL} /root/tfs1/missing --run automake-1.11
AWK = mawk
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lmysqlclient -lboost_filesystem-mt -lboost_date_time-mt -lboost_system-mt -lboost_regex-mt -lboost_thread-mt -lgmp  -lxml2
LTLIBOBJS = 
LUA_CFLAGS = -I/usr/include/lua5.1  
LUA_LIBS = -llua5.1  
MAKEINFO = ${SHELL} /root/tfs1/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
XML_LIBS = -lxml2
abs_builddir = /root/tfs1
abs_srcdir = /root/tfs1
abs_top_builddir = /root/tfs1
abs_top_srcdir = /root/tfs1
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /root/tfs1/install-sh
...
theforgottenserver$(EXEEXT): $(theforgottenserver_OBJECTS) $(theforgottenserver_DEPENDENCIES) 
...
include ./$(DEPDIR)/databaseodbc.Po
