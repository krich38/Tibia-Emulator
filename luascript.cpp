...
lua_register(m_luaState, "getItemParent", LuaScriptInterface::luaGetItemParent);
	...
	lua_register(m_luaState, "doPlayerRemoveSoul", LuaScriptInterface::luaDoPlayerRemoveSoul);
...
int32_t LuaScriptInterface::luaDoPlayerRemoveSoul(lua_State* L)
{
	//doPlayerAddSoul(cid, soul)
	int32_t soul = popNumber(L);
